...
<footer id="footer">
	<div class="inner" id="goinfo">
		...
		<form action="index-secure-server.php" method="post">
			...
			<fieldset>
				...
				<br>
				<label for="id">Welcome, <?php echo $_SESSION['username'];?></label>
				<input type="hidden" name="emailpass" value="<?php echo $_SESSION['email'];?>" />
