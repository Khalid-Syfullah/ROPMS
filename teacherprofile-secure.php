...
<body class="subpage">
	<header id="header">
				<div class="inner">
					...
					<nav id="nav">
						<a href="index-secure.php">Go Back</a>
	  ...
	  <div class="panel-heading">  <h4 >Teacher Profile</h4></div>
	    ...
	    <div class="panel-body">
		  ...
		  <div class="box box-info">
			...
			<form action="teacheredit-secure.php" method="post">
			<?php if($Email == $Emailpass){
			  echo '<input type="submit" name="editprofile" value="Edit Profile" />';
			  }
			  ?>
			 <input type="hidden" name="editpass" value="<?php echo $Email; ?>" />
